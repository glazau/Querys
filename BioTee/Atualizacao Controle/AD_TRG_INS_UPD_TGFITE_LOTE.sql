create or replace NONEDITIONABLE TRIGGER AD_TRG_INS_UPD_TGFITE_LOTE 
    ...
    */       
        ...
        */  
        ...
        IF V_CODPROD = :NEW.CODPROD AND V_CODPARC = 61 AND V_NUMNOTA > 0 AND :OLD.SEQUENCIA = :NEW.SEQUENCIA THEN
        ...
        */ 
        IF INSERTING  AND  V_CODPROD = :NEW.CODPROD AND V_CODPARC = 61 AND V_NUMNOTA > 0 AND :OLD.SEQUENCIA = :NEW.SEQUENCIA THEN
        :NEW.CONTROLE := V_NUMNOTA;
        END IF; 
